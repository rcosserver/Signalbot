...
database = [
    ["Карасев", "Инокентий", "Петрович", "89859906075", 'Отдел ПОК', "455"],
    ["Сикорский", "Андрей", "Венеамивович", "8985986223344", "Отдел ЖАРИМ", "288"],
    ["Гавриков", "Жаксим", "Молегович", "89161484527897", 'Отдел СОК', "185"],
    ["Жулюев", "Святомитрий", "Святосеевич", "898598798789", 'Отдел БОГ', "292"],
     ]
